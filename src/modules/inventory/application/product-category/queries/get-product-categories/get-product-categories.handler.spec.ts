...
describe('GetProductCategoriesHandler', () => {
  ...
  beforeEach(async () => {
    ...
    handler = module.get<GetProductCategoriesHandler>(GetProductCategoriesHandler);
    repository = module.get(ProductCategoryQueriesRepository) as jest.Mocked<ProductCategoryQueriesRepository>;
  });
  ...
  it('should return an array of categories without pagination', async () => {
    ...
    expect(repository.getAll).toHaveBeenCalledWith(undefined, undefined, undefined);
  });
  ...
  it('should return paginated categories', async () => {
    ...
    expect((result as Pagination<ProductCategoryDto>).getEntityList()).toEqual(categories);
