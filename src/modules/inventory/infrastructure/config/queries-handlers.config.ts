...
import { GetAllMeasurementUnitsHandler } from '../../application/queries/measurement-unit/get-all-measurement-units/get-all-measurement-units.handler';
import { GetActiveMeasurementUnitsHandler } from '../../application/queries/measurement-unit/get-active-measurement-units/get-active-measurement-units.handler';
...
export const queryHandlerProviders = [
  ...
  GetActiveMeasurementUnitsHandler,
];
