  ...
  await tx.ctl_category_permissions.createMany({
    data: [
      ...
      // ── Inventario ──
      {
        ...
        description: 'Para el catálogo de categorías de productos del inventario',
        active: true,
        created_at: new Date(),
      },
      {
        ...
        name: 'Productos',
        description: 'Para el mantenimiento de productos del inventario',
        active: true,
        created_at: new Date(),
      },
      {
        id: "00000000-0000-4000-8000-000000000022",
        name: 'Mantenimiento de Productos',
        description: 'Para el registro de mantenimiento de productos',
        active: true,
        created_at: new Date(),
      },
      {
        ...
        name: 'Clientes',
        description: 'Para el mantenimiento de clientes',
        active: true,
        created_at: new Date(),
      },
      {
        ...
        name: 'Reservas',
        description: 'Para el mantenimiento de reservas',
        active: true,
        created_at: new Date(),
      },
      {
        ...
        name: 'Pagos',
        description: 'Para el registro y gestión de pagos',
        active: true,
        created_at: new Date(),
      },
      {
        ...
        name: 'Inspecciones',
        description: 'Para el registro de inspecciones post-evento',
        active: true,
        created_at: new Date(),
      },
      {
        ...
        name: 'Facturación',
        description: 'Para la generación y gestión de facturas',
        active: true,
        created_at: new Date(),
      },
      {
        ...
        name: 'Reportes',
        description: 'Para el acceso a reportes del sistema de inventario',
        active: true,
        created_at: new Date(),
      },
    ],
